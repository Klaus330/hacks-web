  ...
  <div>
      <div class="container">
            <section class="row docs-section flex justify-content-center align-items-center" style="min-height: 100vh;">
                <div class="col-12">
                    <autocomplete-search url="/get-institutions" filterby="name"
                                         v-on:optionSelected="showDetails" placeholder="Ce institutie te intereseaza?"></autocomplete-search>
                </div>
            </section>
        </div>
    <div class="container mt-10">
      <div class="row">
        ...
        >
          <img
            style="width: 80%"
            src="{{asset('/images/svg/institution.svg')}}"
          />
        </div>
      </div>
    </div>
